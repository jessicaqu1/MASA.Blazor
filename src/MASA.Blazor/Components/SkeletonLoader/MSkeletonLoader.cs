...
{
    public partial class MSkeletonLoader : BSkeletonLoader, IMSkeletonLoader, IThemeable
    {
        [Parameter]
            ...
            CssProvider
                .Apply(cssBuilder =>
                {
                    cssBuilder.Add(prefix)
                        ...
                        .AddTheme(this, Themeable?.IsDark ?? false)
                        .AddElevatable(this);
                }, styleBuilder =>
                {
                    styleBuilder.AddMeasurable(this, () => Loading == true);
                });
